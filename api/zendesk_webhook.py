    ...
    for c in reversed(data):
        ...
        if '"classification"' in body:
            ...
            try:
                ...
                # If we can't parse, still treat as found classification to be safe
                return True
    return False
...
class handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        try:
            ...
            # Idempotency guard: skip if a recent classification exists
            ...
            if hasattr(classifier, "classify") and classifier.__class__.__name__ != "RuleBasedClassifier":
                ...
                # Rule-based expects one combined text
            ...
            client.add_private_comment(int(ticket_id), body)

            return self._send(200, {"ok": True, "ticket_id": ticket_id, "classification": result.classification})
